-- Script actualizado para ejecutar después de implementar departmentId
-- Ejecutar en MySQL
...
-- Insertar datos de demo con departmentId incluido
...
('2025-10-20', JSON_OBJECT(
  ...
  'tasks', JSON_ARRAY(
    ...
    JSON_OBJECT('taskId', '105817', 'department', 'SPRINT', 'duration', '3h 55m', 'timeSubmitted', true, 'status', 'DONE', 'description', ': [DEV] UI for file generation\nstarting working on this'),
...
('2025-10-21', JSON_OBJECT(
  'meetings', JSON_ARRAY(
    JSON_OBJECT('title', 'Thanksgiving Day', 'duration', '7h 30m', 'timeSubmitted', false, 'departmentId', 'it-27', 'description', '')
  ),
  'tasks', JSON_ARRAY(),
  'notes', JSON_ARRAY()
), 'structured');
...
SELECT 'Datos con departmentId insertados correctamente' as status;
